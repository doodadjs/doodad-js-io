...
(function() {
	...
	global.DD_MODULES['Doodad.Client.IO'] = {
		type: null,
		version: '0d',
		namespaces: null,
		...
		create: function create(root, /*optional*/_options) {
			...
			if (__Internal__.streamsSupported) {
				...
				files.openFile = function openFile(url, /*optional*/options) {
					...
					return new Promise(function(resolve, reject) {
						...
						__Natives__.windowFetch.call(global, url, init)['finally'](function(response) {
							if (response.ok || (response.status === 0)) {
								return response.blob()['finally'](function(blob) {
			...
			return function init(/*optional*/options) {
				...
				// TEST
				//files.openFile("http://www.doodad-js.local:8080/nodejs/static/core/Doodad.js")
